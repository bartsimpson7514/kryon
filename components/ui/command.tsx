...
>(({ className, ...props }, ref) => (
  <div className="relative flex items-center  rounded-md border-0">
    <CommandPrimitive.Input
      ref={ref}
      className={cn(
        "m-0.5 flex h-11 w-full rounded-md border border-transparent bg-white-v-008 px-4 py-3 text-sm  outline-none backdrop-blur-[16psx] placeholder:text-slate-500 focus:border-white-v-600  focus:shadow-mustard100 disabled:cursor-not-allowed disabled:opacity-50 dark:placeholder:text-slate-400",
        className,
      )}
      {...props}
    />
    <Search className=" absolute right-4 mr-2 h-4 w-4 shrink-0 opacity-50" />
  </div>
))
